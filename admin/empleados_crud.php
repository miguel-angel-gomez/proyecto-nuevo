...
<body class="bg-light">
    <div class="container mt-4 mb-5">
                                ...
                                <form method="POST">
                                    ...
                                    <td>
                                        <select class="form-select form-select-sm" name="estado">
                                            <option value="1" <?= ($emp['estado'] == 1) ? 'selected' : '' ?>> Activo
                                            </option>
                                            <option value="0" <?= ($emp['estado'] == 0) ? 'selected' : '' ?>> Inactivo
                                            </option>
                                        </select>
                                    </td>
                                    <td>
                                        ...
                                        <input type="hidden" name="fecha_creacion"
                                            value="<?= $emp['fecha_creacion'] ?>">
                                    </td>
                                    <td class="d-flex gap-2">
                                        <button type="submit" name="actualizar" class="btn btn-success btn-sm"> Guardar
                                        </button>
        ...
        <div class="card shadow-sm col-lg-8 mx-auto">
            <div class="card-body">
                <h2 class="card-title mb-4 fw-bold text-success"><i class="fa-solid fa-user-plus me-2"></i>Registrar
                    Empleado</h2>
                <form method="POST" autocomplete="off">
                    <div class="row">
                        <div class=" mb-3">
                            ...
                            <input type="text" name="documento" required class="form-control"
                                placeholder="Número de identificación" maxlength="10" pattern="[0-9]{1,10}"
                    ...
                    <div class="row">
                        <div class=" mb-3">
                            ...
                            <input type="password" name="pin" required class="form-control"
                                placeholder="4 dígitos numéricos" maxlength="4" inputmode="numeric"
                    ...
                    <button type="submit" name="crear" class="btn btn-success fw-bold px-4"><i
                            class="fa-solid fa-floppy-disk me-1"></i> Guardar</button>
                    <a href="dashboard.php" class="btn btn-outline-secondary"><i class="fa-solid fa-xmark me-1"></i>
                        Cancelar</a>
                </form>
            </div>
        </div>
