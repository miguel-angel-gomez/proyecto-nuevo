...
<body class="bg-light">
    ...
    <div class="container mt-4">
        ...
        <div class="card shadow-sm col-md-8 mx-auto">
            <div class="card-body">
                <h2 class="card-title mb-4 text-center text-primary fw-bold">
                    <i class="fa-solid fa-gauge me-2"></i>PANEL PRINCIPAL
                </h2>
                ...
                <div class="list-group shadow-sm">
                    <a href="empleados_crud.php?accion=listar" class="list-group-item list-group-item-action py-3 d-flex align-items-center">
                        ...
                        <div>
                            <strong class="d-block">Listado y Control de Empleados</strong>
                            <span class="text-muted small">Ver, activar, desactivar o modificar personal existente.</span>
                        </div>
                    </a>
                    <a href="empleados_crud.php?accion=crear_form" class="list-group-item list-group-item-action py-3 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <span class="text-muted small">Ingresar un nuevo trabajador al sistema con sus credenciales y PIN.</span>
                        </div>
                    </a>
                    <a href="empleados_crud.php?accion=editar_form" class="list-group-item list-group-item-action py-3 d-flex align-items-center">
                        <i class="fa-solid fa-user-pen me-3 text-warning fs-5"></i>
                        <div>
                            <strong class="d-block">Búsqueda Manual (Editar)</strong>
                            <span class="text-muted small">Buscar un empleado directamente usando su documento de identidad.</span>
                        </div>
                    </a>
                </div>
            </div>
